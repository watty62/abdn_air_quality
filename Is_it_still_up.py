...
def query_the_api():
    """ Using a bounding box, retrieves a list containing the json of sensor devices found"""
...
def lookup_host(sensor_id):
    """ check our stored list of hosts' contact details and return an email address if a match found."""
...
def send_alerts_if_down(in_list):
    """ Sends an email to the contact address for each sensor which is reported as being down"""
